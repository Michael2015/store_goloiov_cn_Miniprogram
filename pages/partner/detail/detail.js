...
Page({
  ...
  toList() {
    let share_user_id = app.globalData.userInfo.uid;
    let share_partner_id = app.globalData.userInfo.uid;
    wx.switchTab({
      url: '/pages/partner/index/index?share_user_id='+share_user_id+'&share_partner_id='+share_partner_id,
    })
  },
